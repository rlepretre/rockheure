<template>
  <div class="w-full flex flex-col items-center justify-center px-4 mb-8">
    <div class="w-full lg:w-9/12 h-0.5 bg-gray-100 rounded-full"></div>
    <h1 class="text-4xl font-bold mt-6">Nos partenaires</h1>

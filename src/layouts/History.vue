      ...
      <div class="m-auto my-6">
        ...
        <h1 class="text-xl font-semibold my-4">
          <a
            ...
            target="blank"
          >
            Elise in Chains. Pilgrims. So Pink Size.</a
          >
        </h1>
        <img
          class="shadow rounded object-cover w-full"
      ...
      <div class="m-auto my-6">
        ...
        <h1 class="text-xl font-semibold my-4">
          <a
            ...
            target="blank"
          >
            Tripode. Thomas Gabriel. Suarez.
          </a>
        </h1>
        <img
          class="shadow rounded object-cover w-full"
          src="/history/2017-11.jpg"
        />
      </div>
      ...
      <div class="m-auto my-6">
        ...
        <h1 class="text-xl font-semibold my-4">
          <a
            ...
            target="blank"
          >
            Opalis. Envole-moi. Lady Cover.
          </a>
        </h1>
        <img
          class="shadow rounded object-cover w-full"
          src="/history/2017-3.jpg"
        />
      </div>
